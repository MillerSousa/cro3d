...
import { Plus, Trash2, ChevronDown, ChevronUp, Box, Pencil, X } from 'lucide-react'
...
export function ThreeDTab({ onUsePrice, onSaveDashboard }: ThreeDTabProps) {
  ...
  return (
    <div className="space-y-4 pb-4">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-sm text-muted-foreground font-medium">Parâmetros da impressão</CardTitle>
        </CardHeader>
        <CardContent className="space-y-3">
      ...
      {/* Margins */}
      <Card>
        <CardHeader><CardTitle className="text-sm text-muted-foreground font-medium">Margens</CardTitle></CardHeader>
